...
<ul>
	...
	<li><a href="<?php echo zen_href_link(FILENAME_WISHLIST_MOVE, 'wid='.$id, 'SSL'); ?>"><?php echo UN_TEXT_WISHLIST_MOVE; ?></a></li>
	<?php } ?>
</ul>
...
<div class="buttonRow forward"><?php echo zen_image_submit(UN_BUTTON_IMAGE_SAVE, UN_BUTTON_SAVE_ALT); ?></div>
<?php } ?>
